...
namespace APIVerve
{
    public class CountyDataLookupAPIClient
    {
        ...
        public CountyDataLookupAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public CountyDataLookupAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, countydataQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(countydataQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(countydataQueryOptions options)
        {
